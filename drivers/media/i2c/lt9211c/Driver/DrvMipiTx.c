...
void Drv_MipiTx_DPhySet(void)
{
    ...
    LTLog(LT_LOG_INFO,"MIPI Output PortA");
    ...
    LTLog(LT_LOG_INFO,"MIPI Output PortB");
    #elif (MIPITX_PORT_SEL == DOU_PORT)
    HDMI_WriteI2C_Byte(0x36,(HDMI_ReadI2C_Byte(0x36) | 0x03));
    LTLog(LT_LOG_INFO,"MIPI Output PortA & B");
    #endif
    HDMI_WriteI2C_Byte(0xff,0x82);
...
void Drv_MipiTx_PllSet(IN StructMipiTx* pstMipiTx)
{
    ...
    LTLog(LT_LOG_DEBUG, "ulMipiDataRate:%ld, ulHalfPixClk:%ld, ulMpiTXPhyClk:%ld, ucBpp:%d, ucTxPortNum:0x%02x, ucTxLaneNum:0x%02x",
    ...
    LTLog(LT_LOG_DEBUG,"ucSericlkDiv N1:0x%02x, ucDivSet M2:0x%02x",ucSericlkDiv, ucDivSet);
}
//========================================================================
...
void Drv_MipiTx_PhyTimingParaSet(INOUT StructMipiTx* pstMipiTx, INOUT StructMipiTxDPhy* pstMipiTxDPhy)
{
    ...
    LTLog(LT_LOG_DEBUG, "byteclk: %ldM", ulrdbyteclk);
    ...
    LTLog(LT_LOG_DEBUG, "ck_post (0xD4A9) = 0x%02x", pstMipiTxDPhy->ucClkPost);
    LTLog(LT_LOG_DEBUG, "ck_zero (0xD4A7) = 0x%02x", pstMipiTxDPhy->ucClkZero);
    LTLog(LT_LOG_DEBUG, "hs_lpx  (0xD4A4) = 0x%02x", pstMipiTxDPhy->ucHsLpx);
    LTLog(LT_LOG_DEBUG, "hs_prep (0xD4A5) = 0x%02x", pstMipiTxDPhy->ucHsPrep);
    LTLog(LT_LOG_DEBUG, "hs_trail(0xD4A6) = 0x%02x", pstMipiTxDPhy->ucHsTrail);
    LTLog(LT_LOG_DEBUG, "hs_rqst (0xD48A) = 0x%02x", pstMipiTxDPhy->ucHsRqStPre);
}
