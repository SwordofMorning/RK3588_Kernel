...
void Drv_Csc_Set(void)
{
            ...
            LTLog(LT_LOG_INFO,"Csc Set:    RGB to YUV422");
            ...
            LTLog(LT_LOG_INFO,"Csc Set:    YUV422 to RGB");
            ...
            HDMI_WriteI2C_Byte(0x86,0x04);
            HDMI_WriteI2C_Byte(0x87,0x10);
            LTLog(LT_LOG_INFO,"Csc Set:    YUV422 to YUV444");
            ...
            HDMI_WriteI2C_Byte(0x87,0x10);
            LTLog(LT_LOG_INFO,"Csc Set:    YUV444 to RGB");
            ...
            HDMI_WriteI2C_Byte(0x86,0x40);
            HDMI_WriteI2C_Byte(0x87,0x00);
            LTLog(LT_LOG_INFO,"Csc Set:    YUV444 to YUV422");     
