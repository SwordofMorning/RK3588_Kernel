...
void Mod_MipiTx_ParaSet(void)
{
    ...
    LTLog(LT_LOG_DEBUG, "burst:0x%02x", g_stMipiTx.b1MipiClockburst);
    ...
    {
        LTLog(LT_LOG_ERROR,"Over Maximum MIPITX Datarate");
    }
...
//    ulrddly = (ulrddly_max - ulrddly_min2) / 20 + ulrddly_min2;
    ...
    LTLog(LT_LOG_DEBUG, "rddly is 0x%04lx;",ulrddly);          
}
...
void Mod_MipiTx_Digital_Config(void)
{
    ...
    #endif
    LTLog(LT_LOG_INFO, "MipiTx Output Format: %s",g_szStrTxFormat[g_stMipiTx.ucTxFormat]);
}
